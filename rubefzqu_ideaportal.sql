...
--
-- Host: localhost:3306
-- Generation Time: Dec 14, 2018 at 03:12 AM
...
(20, 'CULTURAL PROGRAM ', '14th April 2018 is the 1st day of Bangla 1425 New Year. We are going to arrange some cultural progra', '2018-04-10', '2018-04-17', '2018-04-04'),
...
(22, 'Library', 'We are going to renovate our institute Library. We will think about all of your choice.', '2018-04-15', '2018-04-27', '2018-04-04'),
...
(28, 'CONTEST', 'University clubs should arrange several types of contest regularly.', '2018-04-12', '2018-04-15', '2018-04-09'),
(29, 'Group Project', 'Every class should submit group project', '2018-04-16', '2018-04-30', '2018-04-10'),
(30, 'UoG assignment', 'About your coursework', '2018-04-28', '2018-04-30', '2018-04-11');
...
(245, 'Right', '2018-04-08 13:32:39', 0, 139, 28),
(246, 'good idea', '2018-04-09 04:49:30', 0, 139, 48),
(247, 'Yes, agree. ', '2018-04-09 16:15:13', 0, 143, 28),
(248, 'Yes, we want the workshop.', '2018-04-09 17:37:51', 0, 108, 28),
(249, 'Please arrange it next week', '2018-04-09 17:46:00', 1, 108, 28),
(250, 'What about the program...??', '2018-04-10 14:00:26', 0, 119, 28),
(251, 'yes we need', '2018-04-11 20:06:40', 0, 145, 26),
(252, 'why man', '2018-04-11 20:07:45', 1, 145, 26),
(253, 'dfgdgdfgdfgdfgdfgdfgdgf', '2018-04-18 17:18:50', 0, 146, 48),
(254, 'Group work is great thing to collaborate with team.', '2018-04-19 02:36:42', 0, 146, 7),
(255, 'Okay', '2018-04-19 02:58:24', 0, 143, 7),
(256, 'That is right ', '2018-04-19 02:59:48', 0, 146, 28),
(257, 'But we need a good environment for group study. ', '2018-04-19 03:00:55', 1, 146, 28),
(258, 'This is an example comment ', '2018-04-19 08:50:37', 0, 147, 28);
...
(139, 'Latest Update', 'Should update information of website day to day', 0, '2018-04-07 18:25:25', NULL, 23, 35),
(140, 'this is an idea title', 'this is description', 0, '2018-04-09 04:50:59', NULL, 19, 48),
(142, 'Poetry', 'Poetry should be added as a part of this program.', 1, '2018-04-09 09:49:10', NULL, 20, 28),
(143, 'Books', 'Library books need to check.', 1, '2018-04-09 09:49:47', 'uploadFileZip/1523267387.zip', 22, 28),
(144, 'Programming Contest', 'Programming contest should be arranged as per pre-scheduled.', 0, '2018-04-09 16:21:36', 'uploadFileZip/1523290896.zip', 28, 28),
(145, 'Develop', 'Website need to develop', 0, '2018-04-11 20:04:05', NULL, 23, 26),
(146, 'Group work', 'DO with your group', 1, '2018-04-11 20:11:16', 'uploadFileZip/1523477475.zip', 29, 26),
(147, 'Test', 'Test description', 0, '2018-04-19 08:48:34', 'uploadFileZip/1524127714.zip', 26, 28),
(148, 'assignment sesh', 'amazing moment', 0, '2018-04-29 11:20:04', 'uploadFileZip/1525000802.zip', 23, 36);
...
(89, 1, 7, 110, '2018-04-04 21:32:36'),
...
(141, 1, 35, 139, '2018-04-07 18:26:53'),
(142, 1, 28, 139, '2018-04-08 13:31:30'),
(143, 1, 48, 139, '2018-04-09 04:49:12'),
(144, 1, 48, 130, '2018-04-09 09:03:04'),
(145, 1, 28, 142, '2018-04-09 09:50:22'),
(146, 1, 28, 144, '2018-04-10 11:10:23'),
(147, 0, 26, 145, '2018-04-11 20:05:16'),
(148, 1, 9, 144, '2018-04-12 08:10:48'),
(149, 1, 48, 146, '2018-04-18 19:35:07'),
(150, 1, 28, 146, '2018-04-19 03:01:25'),
(151, 0, 28, 147, '2018-04-19 08:49:05'),
(152, 0, 36, 148, '2018-04-29 11:21:21'),
(153, 1, 48, 148, '2018-08-03 16:26:47');
...
(36, 'Nasir Hossain', 0, 'zasoilu@gmail.com', '123nsrz45', 321, 'Kathalbagan , Dhak-127', '01756838467', '2018-12-31', 'images/author/rsz_ava.png', 2),
...
(40, 'Sadman Ahmed', 0, 'testing2@gmail.com', '123nsrz45', 321, 'Khulna', '01756838467', '2018-04-15', 'images/author/rsz_ava.png', 2),
...
(45, 'Sadia ', 0, 'testing7@gmail.com', '123nsrz45', 321, 'khulna', '01756838467', '2018-12-31', 'images/author/rsz_ava.png', 4),
...
(49, 'Nagorik', 0, 'nagorik@gmail.com', '12345', 321, 'Dhaka', '123456789', NULL, 'images/author/rsz_ava.png', 3);
...
--
ALTER TABLE `comment`
  MODIFY `comment_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=259;
...
--
ALTER TABLE `page_views`
  MODIFY `page_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=645;

--
-- AUTO_INCREMENT for table `student_ideas`
--
ALTER TABLE `student_ideas`
  MODIFY `ideas_number` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;

--
-- AUTO_INCREMENT for table `thumbsupdown`
--
ALTER TABLE `thumbsupdown`
  MODIFY `thumbs_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=154;
